...
texts = {
    "ru": {
        ...
        "choose_proxy_to_cancel": "Выберите прокси для отмены",
        "proxy_canceled": "Прокси отменено: {proxy}",
        "proxy_cancel_failed": "Не удалось отменить прокси",
    ...
    "en": {
        ...
        "choose_proxy_to_cancel": "Select a proxy to cancel",
        "proxy_canceled": "Proxy canceled: {proxy}",
        "proxy_cancel_failed": "Failed to cancel proxy",
