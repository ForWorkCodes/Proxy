...
texts = {
    "ru": {
        ...
        "choose_proxy_to_cancel": "Выберите прокси для удаления",
        "proxy_deleted": "Прокси удалено: {proxy}",
        "proxy_delete_failed": "Не удалось удалить прокси",
    ...
    "en": {
        ...
        "choose_proxy_to_cancel": "Select a proxy to delete",
        "proxy_deleted": "Proxy deleted: {proxy}",
        "proxy_delete_failed": "Failed to delete proxy",
