...
texts = {
    "ru": {
        ...
        "checker": "Чекер",
        "cancel_proxy": "Отменить автопродление",
        "language": "Язык",
        ...
        "no_auto_prolong_proxies": "У вас нет прокси с автопродлением",
        "no_disabled_auto_prolong_proxies": "У вас нет прокси без автопродления",
        "you_have_proxy_count": "У тебя есть прокси в количестве",
        "download_proxies": "Скачать",
        "choose_proxy_to_cancel": "Выберите прокси для отключения автопродления",
        "proxy_canceled": "Автопродление отключено: {proxy}",
        "proxy_cancel_failed": "Не удалось отключить автопродление",
        "enable_auto_prolong": "Включить автопродление",
        "choose_proxy_to_enable_auto_prolong": "Выберите прокси для включения автопродления",
        "auto_prolong_enabled": "Автопродление включено: {proxy}",
        "auto_prolong_enable_failed": "Не удалось включить автопродление",
        ...
        "notification_admin_alert": "Внимание для админа:",
        "proxy:": "Прокси:",
        "login": "Логин",
        "password": "Пароль",
        "country_ru": "Россия",
    ...
    "en": {
        ...
        "buy_proxy": "Buy Proxy",
        "checker": "Checker",
        "cancel_proxy": "Disable auto-renewal",
        "language": "Language",
        ...
        "no_auto_prolong_proxies": "You don't have proxies with auto-renewal",
        "no_disabled_auto_prolong_proxies": "You don't have proxies without auto-renewal",
        "you_have_proxy_count": "You have proxies in the amount of",
        "download_proxies": "Download",
        "choose_proxy_to_cancel": "Select a proxy to disable auto-renewal",
        "proxy_canceled": "Auto-renewal disabled: {proxy}",
        "proxy_cancel_failed": "Failed to disable auto-renewal",
        "enable_auto_prolong": "Enable auto-renewal",
        "choose_proxy_to_enable_auto_prolong": "Select a proxy to enable auto-renewal",
        "auto_prolong_enabled": "Auto-renewal enabled: {proxy}",
        "auto_prolong_enable_failed": "Failed to enable auto-renewal",
        ...
        "notification_balance_low": "Your balance is running low. Please top up to avoid service interruption.",
        "proxy:": "Proxy:",
        "login": "Login",
        "password": "Password",
        "country_ru": "Russia",
